...
export default function Hero(props : {data : IHeader}) {
  return (
      ...
      <main style={{
        ...
        <div className="pt-10 bg-gray-800 bg-opacity-80 h-auto md:h-screen sm:pt-16 lg:pt-8 lg:pb-14 lg:overflow-hidden">
          <div className="mx-auto max-w-7xl flex flex-col items-center justify-center lg:px-8 h-full">
            <div className="lg:grid lg:grid-cols-2 lg:gap-8 content-center">
              ...
              <div className="mt-12 flex h-full items-center justify-center -mb-16 sm:-mb-48 lg:m-0 lg:relative">
              <motion.div initial={{
                  opacity: 0,
                  x: 70
                }} animate={{
                  ...
                  <div className="px-4 py-8 sm:px-10">
                    <div className="">
                      <p className="text-center text-2xl text-gray-500">Let's Get Your Site SEO <span className="text-green-600 font-semibold">Boosted</span></p>
                    </div>
                    {/* <div>
                    ...
                    <div className="mt-6">
                      <form action="#" method="POST" className="space-y-6">
                        ...
                        <div>
                          <button
                            type="submit"
                            className="w-full bg-green-600 flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                          >
                            Create your account
                          </button>
                        </div>
