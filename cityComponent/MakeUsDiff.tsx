...
interface IMakeUsDiff {
  message : string
  main_review : Review
}
export default function MakeUsDiff(props : {data : IMakeUsDiff}) {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 space-y-8 sm:px-6 lg:px-8">
        ...
        <div className="relative z-10 text-base max-w-prose mx-auto lg:max-w-5xl lg:mx-0 lg:pr-72">
          <p className="text-lg text-gray-500">
            We are an A.I automated SEO agency in toronto.
          </p>
        </div>
        <div className="lg:grid lg:grid-cols-2 lg:gap-8 lg:items-start">
          <div className="relative z-10">
            ...
            }} className="prose prose-green text-gray-500 mx-auto lg:max-w-none">
          ...
          <div className="mt-12 relative text-base max-w-prose mx-auto lg:mt-0 lg:max-w-none">
            ...
            <blockquote className="relative bg-white rounded-lg shadow-lg">
              <div className="rounded-t-lg px-6 py-8 sm:px-10 sm:pt-10 sm:pb-8">
                {/* <img
                  src="https://tailwindui.com/img/logos/workcation-logo-green-600-mark-gray-800-and-green-600-text.svg"
                  alt="Workcation"
                  className="h-8"
                /> */}
                <div className="relative text-lg text-gray-700 font-medium mt-8">
                  ...
                  <p className="relative">
                   {props?.data?.main_review?.message}
                  </p>
                </div>
              </div>
              <cite className="relative flex items-center sm:items-start bg-green-600 rounded-b-lg not-italic py-5 px-6 sm:py-5 sm:pl-12 sm:pr-10 sm:mt-10">
                ...
                <span className="relative ml-4 text-green-300 font-semibold leading-6 sm:ml-24 sm:pl-1">
                  ...
                  <p className="sm:inline">{props?.data?.main_review?.role}</p>
                </span>
              </cite>
            </blockquote>
          </div>
