    ...
    <div className="terms-of-service-area ptb-100">
      <div className="container">
        <div className="terms-of-service-content">
          ...
          <p>
            We may collect different from or about you depending on how you use
            the Services. Below are some examples to help you better understand
            the we collect.
          </p>
          <h3>3. How We Get Data About You</h3>
          <p>
            We use tools like cookies, web beacons, analytics services, and
            advertising providers to gather the listed above. Some of these
            tools offer you the ability to opt out of collection.
          </p>
          ...
          <p>
            You can choose not to provide certain to us, but you may not be able
          ...
          <ol>
            ...
            <li>
              ...
              other types of local storage. Your wireless device may also allow
              you to control whether location or other is collected and shared.
              You can manage Adobe’s LSOs through their Website Storage Settings
              panel.
            </li>
            <li>
              ...
              pages for the Network Advertising Initiative and Digital
              Advertising Alliance, or if you’re located in the European Union,
              visit the Your Online Choices site. To opt out of Google’s display
              advertising or customize Google Display Network ads, visit the
              Google Ads Settings page. To opt out of Taboola’s targeted ads,
              see the Opt-out Link in their Cookie Policy.
            </li>
            <li>
              To update you provide directly, log into your account and update
          ...
          <p>
            ...
            and guardians to take an active role in their children online
